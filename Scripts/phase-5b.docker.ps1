...
#Skip Phase 5b for now
#Write-Output "Phase 5b skipped for now"
#exit 0
...
try {
  ...
  Write-Output "Phase 5b [ERROR] - Install/Update module problem"
  exit (1)
}
...
try {
  ...
  Write-Output "Phase 5b [ERROR] - Install-Package Docker problem"
  exit (1)
}
...
if ($installCompose) {
  try {
    ...
    Write-Output "Phase 5b [ERROR] - Install docker-compose problem"
    exit (1)
  }
}
